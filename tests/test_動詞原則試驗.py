...
@pytest.mark.parametrize('漢字, 臺羅, 預期', [
    ...
    ('會記得', 'ē-kì tit', None),
    ('媠姑娘會記得你', 'Suí koo-niû ē-kì tit lí', [('E動詞（一）', 4, 'ē-kì-tit')]),
    ('袂曉得', 'bē-hiáu--tit', None),
    ('袂曉得', 'bē hiáu--tit', [('E動詞（一）', 1, 'bē-hiáu--tit')]),
    # 動詞原則二：動詞和後接的時貌標誌連寫
    ('徛咧', 'Khiā--leh', None),
    ('徛咧', 'Khiā leh', [('E動詞（二）a', 2, 'Khiā--leh')]),
    ('徛咧', 'Khiā-leh', [('E動詞（二）a', 2, 'Khiā--leh')]),
    ('徛咧講', 'Khiā-leh kóng', None),
    ('徛咧講', 'Khiā leh-kóng', [('E動詞（二）b', 2, 'Khiā-leh kóng')]),
    ('徛咧講', 'Khiā leh kóng', [('E動詞（二）b', 2, 'Khiā-leh kóng')]),
    ('徛咧講', 'Khiā-leh-kóng', [('E動詞（二）b', 2, 'Khiā-leh kóng')]),
    ('徛咧講', 'Khiā--leh kóng', [('E動詞（二）b', 2, 'Khiā-leh kóng')]),
    ...
    ('講煞', 'Kóng-suah', None),
    ('講煞', 'Kóng suah',  [('E動詞（三）a', 2, 'Kóng-suah')]),
    ('寫了', 'Siá-liáu', None),
    ('講好', 'Kóng-hó', None),
    ('整理好', 'Tsíng-lí hó', None),
    ('整理好', 'Tsíng-lí-hó', [('E動詞（三）b', 3, 'Tsíng-lí hó')]),
    ('整理好勢', 'Tsíng-lí hó-sè', None),
    ('整理好勢', 'Tsíng-lí-hó-sè', [('E動詞（三）b', 3, 'Tsíng-lí hó-sè')]),
    ('排做伙', 'Pâi tsò-hué', None),
    ('排做伙', 'Pâi-tsò-hué',  [('E動詞（三）b', 2, 'Pâi tsò-hué')]),
    # 好：當前面接非動詞
    ('真好', 'tsin hó', None),
    ('你好', 'lí hó', None),
])
