...
@pytest.mark.parametrize('漢字, 臺羅, 預期', [
    ...
    ('朋友的物件', 'pîng-iú-ê mi̍h-kiānn', [('E虛詞（二）', 3, 'pîng-iú ê')]),
